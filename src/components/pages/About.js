      ...
      <div className='row'>
        ...
        <div className='col-sm-9 mt-5'>
          ...
          <p className='summary'> 
            ...
            eventually enrolling in a Rutgers Coding Bootcamp course.  During this intensive bootcamp, I learned many different 
            ...
            professional experience and problem-solving skills acquired from my previous engineering positions, along with the 
